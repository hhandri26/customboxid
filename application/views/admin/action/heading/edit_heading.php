      ...
      <!--form-->
        <?php echo form_open_multipart('admin/edit_background/'); ?>
         <div class="form-group">
          ...
          src="<?php echo base_url('assets/img/web/'.$edit_head_id->background);?>" alt="your image" /><br><br>
        ...
        <input type="hidden" name="gambar2" value="<?php echo $edit_head_id->background?>">
...
<section class="content">
  <div class="box box-default">
    <div class="box-body">
      <!--form-->
      <?php echo form_open('admin/edit_heading_pro'); ?>
